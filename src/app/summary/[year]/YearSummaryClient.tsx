...
export default function YearSummaryClient({
  ...
  const allSongsForYear = fetchedInitialSongs ?? initialSongs;
  const {
    songs: songsFiltered,
    searchTerm,
    setSearchTerm,
  ...
  const changeCurrentSong = (song: Song | null) => {
    console.log("changeCurrentSong", song?.title);
  };
              ...
              >
                ...
                >
                  <div className="w-full aspect-video bg-black">
                    <img
                      src={`https://i.ytimg.com/vi/${g.video_id}/hqdefault.jpg`}
                      alt={g.title}
